...
const SignIn = ({signInStatus, usernameData, viewSignUp, setLocalStorage, logOut, logIn, updateViewingPost, toggleCreatingPost}) => {
    ...
    async function handleSubmitLogin(event) {
        ...
        const response = await fetch(`${import.meta.env.VITE_PROD_API_URL}/login`, {
            method: "POST",
            headers: {
        ...
        if (response.ok) {
            ...
            const userResponse = await fetch(`${import.meta.env.VITE_PROD_API_URL}/users/${username}`, {
                method: "GET",
                headers: {
                    "Content-type": "application/json",
    ...
    async function handleSubmitSignUp(event) {
        ...
        const response = await fetch(`${import.meta.env.VITE_PROD_API_URL}/users`, {
            method: "POST",
            headers: {
                "Content-type": "application/json",
            },
            body: JSON.stringify({ username, password, email, isAuthor }),
        });
